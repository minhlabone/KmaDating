...
public class MessageAdapter extends ArrayAdapter<Message> {
    ...
    private CircleImageView imge_UserReceived;
...
//        imge_UserReceived = (CircleImageView)ListItemView.findViewById(R.id.custom_UserImage1);
...
//            Picasso.get().load(currentMessage.getFriends().getFriendImage()).placeholder(R.drawable.user).into(imge_UserReceived);
